...
-- 1. Insertar en clientes (usando ids de informacion_clientes_personal ya existentes)
...
-- 3. Insertar razas asociadas a especies
...
-- 4. Insertar mascotas asociadas a clientes y razas
...
-- (Opcional) Consulta para verificar los datos insertados:
-- SELECT m.id, m.nombre AS mascota, m.edad, m.sexo, m.estado_vital, 
--        c.id AS cliente_id, r.nombre AS raza, e.nombre AS especie
-- FROM mascotas m
